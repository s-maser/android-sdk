...
public interface ShortUUID {
    ...
    static String CHARACTERISTIC_MQTT_HOST = "2402";
    static String CHARACTERISTIC_MQTT_USER = "2403";
    static String CHARACTERISTIC_MQTT_PASSWORD = "2404";
    static String CHARACTERISTIC_MQTT_CLIENT_ID = "2405";
    static String CHARACTERISTIC_MQTT_TOPIC = "2406";
