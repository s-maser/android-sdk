...
public class RelayrSdk {
    ...
    @Inject
    static OnBoardingClient mOnBoardingClient;
    @Inject
    static BleUtils mBleUtils;
    @Inject
    static RelayrBleSdk mRelayrBleSdk;
    @Inject
    static Logger mLoggerUtils;
    @Inject
    static ReachabilityUtils mReachabilityUtils;
