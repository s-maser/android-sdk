...
public interface Relayr_BLEDeviceConnectionCalback {
	...
	public void onWriteSucess(Relayr_BLEDevice device, DeviceCharacteristic characteristic);
	public void onWriteError(Relayr_BLEDevice device, DeviceCharacteristic characteristic, int errorStatus);
}
