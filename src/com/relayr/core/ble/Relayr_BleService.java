 ...
 */
public class Relayr_BleService extends Service implements Relayr_BleServiceListener {
    @SuppressWarnings("UnusedDeclaration")
    private final static String TAG = Relayr_BleService.class.getSimpleName();

    private final static String INTENT_PREFIX = Relayr_BleService.class.getPackage().getName();
    ...
    public class LocalBinder extends Binder {
        public Relayr_BleService getService() {
            return Relayr_BleService.this;
        }
    }
    ...
    private final Relayr_BleManager bleManager = new Relayr_BleManager();
    private Relayr_BleServiceListener serviceListener;
    ...
    public Relayr_BleManager getBleManager() {
        return bleManager;
    }

    public void setServiceListener(Relayr_BleServiceListener listener) {
